...
export const RegisterPage: React.FC = () => {
  ...
  const { isAuthenticated, signUp, isLoading, error, clearError, isConfigured } = useAuth();
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
      <div className="max-w-md w-full bg-white rounded-3xl border border-slate-200/90 shadow-xl p-6 sm:p-8 space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">{t('auth', 'signUpTitle')}</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="reg-name" className="block text-xs font-semibold text-slate-700 mb-1">{t('auth', 'fullNameLabel')}</label>
          ...
          <div>
            <label htmlFor="reg-email" className="block text-xs font-semibold text-slate-700 mb-1">{t('auth', 'emailLabel')}</label>
            <div className="relative">
          ...
          <div>
            <label htmlFor="reg-password" className="block text-xs font-semibold text-slate-700 mb-1">{t('auth', 'passwordLabel')}</label>
            <div className="relative">
