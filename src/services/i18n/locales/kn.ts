...
export const kn: TranslationDictionary = {
  "nav": {
    ...
    "vaccination": "ಲಸಿಕೆ",
    "healthyHabits": "ಆರೋಗ್ಯಕರ ಅಭ್ಯಾಸಗಳು",
    ...
    "explainReport": "ವರದಿಯನ್ನು ವಿವರಿಸಿ",
    "signIn": "ಸೈನ್ ಇನ್",
    "signOut": "ಸೈನ್ ಔಟ್",
    "selectLanguage": "ಭಾಷೆಯನ್ನು ಆಯ್ಕೆಮಾಡಿ",
    "appTitle": "HealthWise",
    "appSubtitle": "ಸಾರ್ವಜನಿಕ ಆರೋಗ್ಯ ಜಾಗೃತಿ"
  },
  "chat": {
    "title": "HealthWise AI",
    "evidenceGrounded": "ಆಧಾರ ಸಹಿತ ಆರೋಗ್ಯ ಮಾಹಿತಿ",
    "newChat": "ಹೊಸ ಚಾಟ್",
    "startTitle": "ಆರೋಗ್ಯ ಸಂಭಾಷಣೆಯನ್ನು ಪ್ರಾರಂಭಿಸಿ",
    "startDesc": "ರೋಗ ಲಕ್ಷಣಗಳು, ತಡೆಗಟ್ಟುವ ಕ್ರಮಗಳು, ಲಸಿಕೆ ಅಥವಾ ಪೌಷ್ಟಿಕಾಂಶದ ಬಗ್ಗೆ ಕೇಳಿ.",
    "placeholder": "ರೋಗ, ಲಕ್ಷಣ, ತಡೆಗಟ್ಟುವಿಕೆ, ಲಸಿಕೆ ಕುರಿತು ಪ್ರಶ್ನೆ ಕೇಳಿ...",
    "send": "ಕಳುಹಿಸಿ",
    "disclaimer": "ಕೇವಲ ಶೈಕ್ಷಣಿಕ ಮಾಹಿತಿ. ವೈದ್ಯಕೀಯ ಚಿಕಿತ್ಸೆಗಾಗಿ ವೈದ್ಯರನ್ನು ಸಂಪರ್ಕಿಸಿ.",
    "analyzing": "ವೈದ್ಯಕೀಯ ಆಧಾರಗಳನ್ನು ವಿಶ್ಲೇಷಿಸಲಾಗುತ್ತಿದೆ...",
    "emergencyAlertTitle": "ತುರ್ತು ಎಚ್ಚರಿಕೆ",
    "sources": "ಮೂಲಗಳು:",
    "askAI": "AI ಯನ್ನು ಕೇಳಿ",
    "emergencyHotlines": "ತುರ್ತು ಸಹಾಯವಾಣಿ"
  },
  "diseases": {
    "badge": "ವೈದ್ಯಕೀಯ ಮಾರ್ಗದರ್ಶಿ",
    "title": "ರೋಗ ಕೋಶ & ಕ್ಲಿನಿಕಲ್ ಮಾರ್ಗದರ್ಶಿ",
    "subtitle": "ವಿಶ್ವ ಆರೋಗ್ಯ ಸಂಸ್ಥೆಯ (WHO) ಅಧಿಕೃತ ದಾಖಲೆಗಳ ಆಧಾರಿತ ಮಾಹಿತಿ.",
    "searchPlaceholder": "ರೋಗಗಳು, ಲಕ್ಷಣಗಳು ಅಥವಾ ಪದಗಳನ್ನು ಹುಡುಕಿ...",
    "filterBy": "ಫಿಲ್ಟರ್:",
    "all": "ಎಲ್ಲಾ",
    "keySigns": "ಪ್ರಮುಖ ಲಕ್ಷಣಗಳು:",
    "readGuide": "ಮಾರ್ಗದರ್ಶಿ ಓದಿ",
    "askAI": "AI ಯನ್ನು ಕೇಳಿ",
    "whoGrounded": "WHO ಆಧಾರಿತ",
    "noResults": "ಯಾವುದೇ ರೋಗಗಳು ಕಂಡುಬಂದಿಲ್ಲ",
    "noResultsDesc": "ದಯವಿಟ್ಟು ಬೇರೆ ಪದಗಳಿಂದ ಹುಡುಕಿ."
  },
  "diseaseDetail": {
    "back": "ರೋಗಗಳ ಪಟ್ಟಿಗೆ ಹಿಂತಿರುಗಿ",
    "bookmark": "ಉಳಿಸಿ",
    "bookmarked": "ಉಳಿಸಲಾಗಿದೆ",
    "share": "ಹಂಚಿಕೊಳ್ಳಿ",
    "linkCopied": "ಲಿಂಕ್ ನಕಲಿಸಲಾಗಿದೆ",
    "askAI": "ಇದರ ಬಗ್ಗೆ AI ಯನ್ನು ಕೇಳಿ",
    "reviewed": "ವೈದ್ಯಕೀಯವಾಗಿ ಪರಿಶೀಲಿಸಲಾಗಿದೆ",
    "symptomsTitle": "ಸಾಮಾನ್ಯ ಲಕ್ಷಣಗಳು",
    "symptomsSubtitle": "ಸಾಮಾನ್ಯವಾಗಿ ಕಂಡುಬರುವ ಲಕ್ಷಣಗಳು.",
    "warningSignsTitle": "ಅಪಾಯಕಾರಿ ಮುನ್ನೆಚ್ಚರಿಕೆ ಚಿಹ್ನೆಗಳು",
    "warningSignsSubtitle": "ತಕ್ಷಣದ ವೈದ್ಯಕೀಯ ಚಿಕಿತ್ಸೆ ಅಗತ್ಯವಿರುವ ಲಕ್ಷಣಗಳು.",
    "riskFactorsTitle": "ಅಪಾಯದ ಅಂಶಗಳು",
    "riskFactorsSubtitle": "ರೋಗದ ಅಪಾಯವನ್ನು ಹೆಚ್ಚಿಸುವ ಕಾರಣಗಳು.",
    "preventionTitle": "ತಡೆಗಟ್ಟುವ ವಿಧಾನಗಳು",
    "preventionSubtitle": "WHO ಶಿಫಾರಸು ಮಾಡಿದ ಕ್ರಮಗಳು.",
    "whenToSeekCareTitle": "ವೈದ್ಯರನ್ನು ಯಾವಾಗ ಭೇಟಿ ಮಾಡಬೇಕು",
    "ctaTitle": "ಈ ರೋಗದ ಕುರಿತು ಪ್ರಶ್ನೆಗಳಿವೆಯೇ?",
    "ctaDesc": "ನಮ್ಮ AI ಸಹಾಯಕರು ನಿಮಗೆ ಅಗತ್ಯ ಮಾಹಿತಿ ನೀಡುತ್ತಾರೆ.",
    "startConversation": "ಸಂಭಾಷಣೆ ಪ್ರಾರಂಭಿಸಿ",
    "relatedTitle": "ಸಂಬಂಧಿತ ರೋಗಗಳು"
  },
  "resources": {
    "badge": "ಆರೋಗ್ಯ ಸಂಪನ್ಮೂಲ",
    "title": "ಪರಿಶೀಲಿಸಿದ ಆರೋಗ್ಯ ಸಂಪನ್ಮೂಲಗಳು",
    "subtitle": "ಅಧಿಕೃತ ಪೋರ್ಟಲ್‌ಗಳು ಮತ್ತು ತುರ್ತು ಸಂಖ್ಯೆಗಳು.",
    "emergencySectionTitle": "ತುರ್ತು ಸೇವೆಗಳು",
    "emergencySectionDesc": "ವೈದ್ಯಕೀಯ ತುರ್ತು ಸಂದರ್ಭಗಳಲ್ಲಿ ತಕ್ಷಣವೇ ಕರೆ ಮಾಡಿ.",
    "callNow": "ಕರೆ ಮಾಡಿ",
    "portalsTitle": "ಅಧಿಕೃತ ಪೋರ್ಟಲ್‌ಗಳು",
    "portalsSubtitle": "WHO ಮತ್ತು ಆರೋಗ್ಯ ಇಲಾಖೆಯ ವೆಬ್‌ಸೈಟ್‌ಗಳು.",
    "searchPlaceholder": "ಸಂಪನ್ಮೂಲ ಹುಡುಕಿ...",
    "visit": "ಭೇಟಿ ನೀಡಿ",
    "verified": "ಪರಿಶೀಲಿಸಲಾಗಿದೆ"
  },
  "bookmarks": {
    "title": "ಉಳಿಸಿದ ಅಂಶಗಳು",
    "subtitle": "ನೀವು ಬುಕ್‌ಮಾರ್ಕ್ ಮಾಡಿದ ಮಾರ್ಗದರ್ಶಿಗಳು.",
    "all": "ಎಲ್ಲಾ",
    "diseases": "ರೋಗಗಳು",
    "external": "ಸಂಪನ್ಮೂಲಗಳು",
    "emptyTitle": "ಯಾವುದೇ ಬುಕ್‌ಮಾರ್ಕ್‌ಗಳಿಲ್ಲ",
    "emptyDesc": "ಮುಂದಿನ ಉಲ್ಲೇಖಕ್ಕಾಗಿ ಮಾರ್ಗದರ್ಶಿಗಳನ್ನು ಉಳಿಸಿ.",
    "browseBtn": "ರೋಗಗಳನ್ನು ಬ್ರೌಸ್ ಮಾಡಿ",
    "readGuide": "ಮಾರ್ಗದರ್ಶಿ ಓದಿ",
    "visitResource": "ಸಂಪನ್ಮೂಲಕ್ಕೆ ಭೇಟಿ ನೀಡಿ",
    "savedOn": "ಉಳಿಸಿದ ದಿನಾಂಕ:",
    "guestNotice": "ಅತಿಥಿ ಮೋಡ್: ಬ್ರೌಸರ್‌ನಲ್ಲಿ ಮಾತ್ರ ಉಳಿಸಲಾಗುತ್ತದೆ.",
    "signInLink": "ಸಿಂಕ್ ಮಾಡಲು ಲಾಗಿನ್ ಮಾಡಿ"
  },
  "safety": {
    "mandatoryDisclaimer": "HealthWise AI ಸಾರ್ವಜನಿಕ ಆರೋಗ್ಯ ಜಾಗೃತಿಗಾಗಿ ಮಾತ್ರವಾಗಿದ್ದು, ವೈದ್ಯರ ಸಲಹೆಗೆ ಪರ್ಯಾಯವಲ್ಲ.",
    "emergencyEscalationTitle": "ತುರ್ತು ವೈದ್ಯಕೀಯ ಎಚ್ಚರಿಕೆ",
    "emergencyEscalationMessage": "ಈ ಲಕ್ಷಣಗಳು ಗಂಭೀರವಾಗಿರಬಹುದು. ತಕ್ಷಣವೇ ಆಂಬ್ಯುಲೆನ್ಸ್ (108) ಕರೆ ಮಾಡಿ."
  },
  "home": {
...
"faqBadge": "Common Questions",
  ...
  "voice": {
    "statusListening": "ಕೇಳಿಸಿಕೊಳ್ಳುತ್ತಿದ್ದೇವೆ... ಸಹಜವಾಗಿ ಮಾತನಾಡಿ",
    "statusThinking": "ಆಲೋಚಿಸುತ್ತಿದ್ದೇವೆ ಮತ್ತು ವೈದ್ಯಕೀಯ ಸತ್ಯಗಳನ್ನು ಪರಿಶೀಲಿಸುತ್ತಿದ್ದೇವೆ...",
    "statusSpeaking": "ಮಾತನಾಡುತ್ತಿದ್ದೇವೆ... (ನಿಲ್ಲಿಸಲು ಟ್ಯಾಪ್ ಮಾಡಿ ಅಥವಾ ಮಾತನಾಡಿ)",
    "statusInterrupted": "ಅಡ್ಡಿಯಾಗಿದೆ! ಮತ್ತೆ ಕೇಳಿಸಿಕೊಳ್ಳುತ್ತಿದ್ದೇವೆ...",
    "statusError": "ಧ್ವನಿ ಮೋಡ್ ಲಭ್ಯವಿಲ್ಲ",
    "statusIdle": "ಹೆಲ್ತ್‌ವೈಸ್ ಧ್ವನಿ",
    "unavailableNotice": "ಈ ಭಾಷೆಗೆ ಧ್ವನಿ ಇನ್‌ಪುಟ್ ಸದ್ಯಕ್ಕೆ ಲಭ್ಯವಿಲ್ಲ.",
    "micPermissionDenied": "ಮೈಕ್ರೊಫೋನ್ ಅನುಮತಿ ನಿರಾಕರಿಸಲಾಗಿದೆ.",
    "tapToSpeak": "ಮಾತನಾಡಲು ಟ್ಯಾಪ್ ಮಾಡಿ",
    "tapToInterrupt": "ನಿಲ್ಲಿಸಲು ಟ್ಯಾಪ್ ಮಾಡಿ",
    "speakingNotice": "ಉತ್ತರ ಮುಗಿದ ನಂತರ ತಾನಾಗಿಯೇ ಮತ್ತೆ ಕೇಳಲು ಪ್ರಾರಂಭಿಸುತ್ತದೆ.",
    "closeVoice": "ಧ್ವನಿ ಮೋಡ್ ಮುಚ್ಚಿ",
    "emergencyNotice": "ತುರ್ತು ಎಚ್ಚರಿಕೆ ಪತ್ತೆಯಾಗಿದೆ.",
    "ttsUnavailableNotice": "ಈ ಸಾಧನದಲ್ಲಿ ಈ ಭಾಷೆಗೆ ಧ್ವನಿ ಔಟ್‌ಪುಟ್ ಲಭ್ಯವಿಲ್ಲ."
  }
};
