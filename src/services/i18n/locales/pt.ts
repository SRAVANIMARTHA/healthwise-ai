...
export const pt: TranslationDictionary = {
  "nav": {
    ...
    "explainReport": "Explicar Exame",
    "signIn": "Entrar",
    "signOut": "Sair",
    "selectLanguage": "Selecionar Idioma",
    "appTitle": "HealthWise",
    "appSubtitle": "Conscientização em Saúde Pública"
  },
  "chat": {
    "title": "HealthWise AI",
    "evidenceGrounded": "Baseado em Evidências",
    "newChat": "Nova Conversa",
    "startTitle": "Inicie uma Conversa sobre Saúde",
    "startDesc": "Tire dúvidas sobre sintomas, prevenção, vacinação ou alimentação saudável.",
    "placeholder": "Pergunte sobre uma doença, sintoma, vacina...",
    "send": "Enviar",
    "disclaimer": "Informações educativas de saúde. Consulte um médico para orientação.",
    "analyzing": "Analisando evidências médicas...",
    "emergencyAlertTitle": "ALERTA DE EMERGÊNCIA",
    "sources": "Fontes:",
    "askAI": "Perguntar à IA",
    "emergencyHotlines": "Telefones de Emergência"
  },
  "diseases": {
    "badge": "Diretório Médico",
    "title": "Guia de Doenças e Orientações Clínicas",
    "subtitle": "Resumos baseados em evidências da Organização Mundial da Saúde (OMS).",
    "searchPlaceholder": "Buscar doenças, sintomas ou termos...",
    "filterBy": "Filtrar:",
    "all": "Todos",
    "keySigns": "Sinais Clínicos Principais:",
    "readGuide": "Ler Guia",
    "askAI": "Perguntar à IA",
    "whoGrounded": "Baseado na OMS",
    "noResults": "Nenhuma doença encontrada",
    "noResultsDesc": "Tente buscar por outro termo."
  },
  "diseaseDetail": {
    "back": "Voltar para Doenças",
    "bookmark": "Salvar",
    "bookmarked": "Salvo",
    "share": "Compartilhar",
    "linkCopied": "Link copiado para a área de transferência",
    "askAI": "Perguntar à IA sobre isto",
    "reviewed": "Revisão Médica Verificada",
    "symptomsTitle": "Sinais e Sintomas Comuns",
    "symptomsSubtitle": "Manifestações clínicas habituais.",
    "warningSignsTitle": "Sinais de Alerta Críticos",
    "warningSignsSubtitle": "Sintomas que requerem atenção médica imediata.",
    "riskFactorsTitle": "Fatores de Risco",
    "riskFactorsSubtitle": "Fatores que aumentam a suscetibilidade.",
    "preventionTitle": "Estratégias de Prevenção",
    "preventionSubtitle": "Medidas recomendadas pela OMS.",
    "whenToSeekCareTitle": "Quando Procurar um Médico",
    "ctaTitle": "Tem dúvidas sobre esta condição?",
    "ctaDesc": "Nosso assistente educativo está pronto para ajudar.",
    "startConversation": "Iniciar Conversa",
    "relatedTitle": "Condições Relacionadas"
  },
  "resources": {
    "badge": "Diretório de Saúde",
    "title": "Recursos de Saúde Verificados",
    "subtitle": "Portais oficiais e números de emergência.",
    "emergencySectionTitle": "Serviços de Emergência",
    "emergencySectionDesc": "Ligue imediatamente em emergências médicas.",
    "callNow": "Ligar",
    "portalsTitle": "Portais Oficiais",
    "portalsSubtitle": "Sites da OMS e órgãos de saúde.",
  ...
  "bookmarks": {
    "title": "Itens Salvos",
    "subtitle": "Seus guias e recursos favoritos.",
    "all": "Todos",
    "diseases": "Doenças",
    "external": "Recursos",
    "emptyTitle": "Nenhum favorito salvo",
    "emptyDesc": "Salve conteúdos para consultá-los com rapidez.",
    "browseBtn": "Explorar Doenças",
    "readGuide": "Ler Guia",
    "visitResource": "Acessar Recurso",
    "savedOn": "Salvo em",
    "guestNotice": "Modo visitante: salvos no navegador.",
    "signInLink": "Entre para sincronizar"
  },
  "safety": {
    "mandatoryDisclaimer": "O HealthWise AI é um recurso informativo e não substitui o diagnóstico médico.",
    "emergencyEscalationTitle": "ALERTA DE EMERGÊNCIA MÉDICA",
    "emergencyEscalationMessage": "Os sintomas descritos podem ser graves. Ligue imediatamente para o serviço de emergência."
  },
  "home": {
...
"faqBadge": "Common Questions",
  ...
  "voice": {
    "statusListening": "Ouvindo... Fale normalmente",
    "statusThinking": "Pensando e verificando dados médicos...",
    "statusSpeaking": "Falando... (Toque para interromper)",
    "statusInterrupted": "Interrompido! Ouvindo novamente...",
    "statusError": "Modo de voz indisponível",
    "statusIdle": "Voz HealthWise",
    "unavailableNotice": "A entrada de voz não está disponível no momento para este idioma.",
    "micPermissionDenied": "Acesso ao microfone negado.",
    "tapToSpeak": "Toque para falar",
    "tapToInterrupt": "Toque para interromper",
    "speakingNotice": "Ouvirá novamente após o término da resposta.",
    "closeVoice": "Fechar modo de voz",
    "emergencyNotice": "Aviso de emergência médica detectado.",
    "ttsUnavailableNotice": "A saída de voz não está disponível para este idioma neste dispositivo."
  }
};
