...
export const ur: TranslationDictionary = {
  "nav": {
    ...
    "profile": "پروفائل",
    "admin": "ایڈمن کنسول",
    "explainReport": "رپورٹ کی وضاحت کریں",
    "signIn": "سائن ان",
    "signOut": "سائن آؤٹ",
    "selectLanguage": "زبان منتخب کریں",
    "appTitle": "HealthWise",
    "appSubtitle": "عوامی صحت کی آگاہی"
  },
  "chat": {
    "title": "HealthWise AI",
    "evidenceGrounded": "شواہد پر مبنی معلومات",
    "newChat": "نئی گفتگو",
    "startTitle": "صحت سے متعلق گفتگو شروع کریں",
    "startDesc": "علامات، احتیاطی تدابیر، ویکسین شیڈول یا خوراک کے بارے میں پوچھیں۔",
    "placeholder": "کسی بیماری، علامت یا ویکسین کے بارے میں پوچھیں...",
    "send": "ارسال کریں",
    "disclaimer": "صرف تعلیمی مقاصد کے لیے۔ طبی مشورے کے لیے ڈاکٹر سے رجوع کریں۔",
    "analyzing": "طبی شواہد کا تجزیہ کیا جا رہا ہے...",
    "emergencyAlertTitle": "ہنگامی انتباہ",
    "sources": "ذرائع:",
    "askAI": "AI سے پوچھیں",
    "emergencyHotlines": "ایمرجنسی ہیلپ لائنز"
  },
  "diseases": {
    "badge": "طبی ڈائرکٹری",
    "title": "بیماریوں کی معلومات اور طبی گائیڈز",
    "subtitle": "عالمی ادارہ صحت (WHO) کی مستند معلومات پر مبنی۔",
    "searchPlaceholder": "بیماریاں، علامات یا الفاظ تلاش کریں...",
    "filterBy": "فلٹر کریں:",
    "all": "تمام",
    "keySigns": "اہم علامات:",
    "readGuide": "گائیڈ پڑھیں",
    "askAI": "AI سے پوچھیں",
    "whoGrounded": "WHO پر مبنی",
    "noResults": "کوئی نتائج نہیں ملے",
    "noResultsDesc": "براہ کرم دوسرے الفاظ کے ساتھ کوشش کریں۔"
  },
  "diseaseDetail": {
    "back": "بیماریوں کی فہرست پر واپس جائیں",
    "bookmark": "محفوظ کریں",
    "bookmarked": "محفوظ ہو گیا",
    "share": "شیئر کریں",
    "linkCopied": "لنک کاپی ہو گیا ہے",
    "askAI": "اس بارے میں AI سے پوچھیں",
    "reviewed": "طبی طور پر تصدیق شدہ",
    "symptomsTitle": "عام علامات",
    "symptomsSubtitle": "عام طور پر ظاہر ہونے والی علامات۔",
    "warningSignsTitle": "خطرناک انتباہی علامات",
    "warningSignsSubtitle": "جن کے لیے فوری طبی توجہ درکار ہوتی ہے۔",
    "riskFactorsTitle": "خطرے کے عوامل",
    "riskFactorsSubtitle": "جو بیماری کے امکان کو بڑھاتے ہیں۔",
    "preventionTitle": "احتیاطی تدابیر",
    "preventionSubtitle": "WHO کی تجویز کردہ ہدایات۔",
    "whenToSeekCareTitle": "ڈاکٹر سے کب رجوع کریں",
    "ctaTitle": "کوئی سوالات ہیں؟",
    "ctaDesc": "ہمارا AI معاون آپ کی رہنمائی کے لیے حاضر ہے۔",
    "startConversation": "گفتگو شروع کریں",
    "relatedTitle": "متعلقہ موضوعات"
  },
  "resources": {
    "badge": "صحت کے وسائل",
    "title": "تصدیق شدہ طبی وسائل",
    "subtitle": "سرکاری پورٹلز اور ایمرجنسی نمبرز۔",
    "emergencySectionTitle": "ایمرجنسی سروسز",
    "emergencySectionDesc": "طبی ایمرجنسی کی صورت میں فوری کال کریں۔",
    "callNow": "کال کریں",
    "portalsTitle": "سرکاری پورٹلز",
    "portalsSubtitle": "WHO اور وزارت صحت کی ویب سائٹس۔",
    "searchPlaceholder": "وسائل تلاش کریں...",
    "visit": "ملاحظہ کریں",
    "verified": "تصدیق شدہ"
  },
  "bookmarks": {
    "title": "محفوظ کردہ مواد",
    "subtitle": "آپ کے محفوظ کردہ گائیڈز۔",
    "all": "تمام",
    "diseases": "بیماریاں",
    "external": "وسائل",
    "emptyTitle": "کوئی بک مارک محفوظ نہیں ہے",
    "emptyDesc": "آسانی سے رسائی کے لیے گائیڈز کو محفوظ کریں۔",
    "browseBtn": "بیماریاں دیکھیں",
    "readGuide": "گائیڈ پڑھیں",
    "visitResource": "وسائل دیکھیں",
    "savedOn": "محفوظ کرنے کی تاریخ:",
    "guestNotice": "مہمان موڈ: صرف براؤزر میں محفوظ ہوتا ہے۔",
    "signInLink": "ہم آہنگ کرنے کے لیے لاگ ان کریں"
  },
  "safety": {
    "mandatoryDisclaimer": "HealthWise AI صرف تعلیمی مقصد کے لیے ہے اور ڈاکٹر کے مشورے کا متبادل نہیں ہے۔",
    "emergencyEscalationTitle": "طبی ہنگامی انتباہ",
    "emergencyEscalationMessage": "یہ علامات جان لیوا ہو سکتی ہیں۔ فوری طور پر ایمبولینس بلائیں۔"
  },
  "home": {
...
"faqBadge": "Common Questions",
  ...
  "voice": {
    "statusListening": "سن رہے ہیں... قدرتی طور پر بولیں",
    "statusThinking": "سوچ رہے ہیں اور طبی حقائق کی تصدیق کر رہے ہیں...",
    "statusSpeaking": "بول رہے ہیں... (روکنے کے لیے ٹیپ کریں یا بولیں)",
    "statusInterrupted": "مداخلت ہوئی! دوبارہ سن رہے ہیں...",
    "statusError": "وائس موڈ دستیاب نہیں ہے",
    "statusIdle": "ہیلتھ وائز وائس",
    "unavailableNotice": "اس زبان کے لیے وائس ان پٹ فی الحال دستیاب نہیں ہے۔",
    "micPermissionDenied": "مائیکروفون تک رسائی مسترد کر دی گئی۔",
    "tapToSpeak": "بولنے کے لیے ٹیپ کریں",
    "tapToInterrupt": "روکنے کے لیے ٹیپ کریں",
    "speakingNotice": "جواب مکمل ہونے پر خود بخود دوبارہ سننا شروع ہو جائے گا۔",
    "closeVoice": "وائس موڈ بند کریں",
    "emergencyNotice": "ہنگامی انتباہ کی نشاندہی ہوئی۔",
    "ttsUnavailableNotice": "اس ڈیوائس پر اس زبان کے لیے آواز کا آؤٹ پٹ دستیاب نہیں ہے۔"
  }
};
