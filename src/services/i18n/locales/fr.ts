...
export const fr: TranslationDictionary = {
  "nav": {
    ...
    "healthyHabits": "Habitudes Saines",
    ...
    "explainReport": "Expliquer le Rapport",
    "signIn": "Se connecter",
    "signOut": "Se déconnecter",
    "selectLanguage": "Choisir la langue",
    "appTitle": "HealthWise",
    "appSubtitle": "Sensibilisation à la santé publique"
  },
  "chat": {
    "title": "HealthWise AI",
    "evidenceGrounded": "Fondé sur des preuves",
    "newChat": "Nouvelle discussion",
    "startTitle": "Démarrer une conversation santé",
    "startDesc": "Posez des questions sur les symptômes, la prévention, les vaccins ou la nutrition.",
    "placeholder": "Posez une question sur une maladie, un symptôme, un vaccin...",
    "send": "Envoyer",
    "disclaimer": "Informations éducatives uniquement. Consultez un médecin pour un avis médical.",
    "analyzing": "Analyse des données médicales...",
    "emergencyAlertTitle": "ALERTE D'URGENCE",
    "sources": "Sources :",
    "askAI": "Demander à l'IA",
    "emergencyHotlines": "Numéros d'urgence"
  },
  "diseases": {
    "badge": "Répertoire médical",
    "title": "Explorateur des maladies et guides cliniques",
    "subtitle": "Résumés fondés sur des données de l'Organisation mondiale de la Santé (OMS).",
    "searchPlaceholder": "Rechercher des maladies, symptômes ou mots-clés...",
    "filterBy": "Filtrer :",
    "all": "Tout",
    "keySigns": "Signes cliniques clés :",
    "readGuide": "Lire le guide",
    "askAI": "Demander à l'IA",
    "whoGrounded": "Basé sur l'OMS",
    "noResults": "Aucune maladie trouvée",
    "noResultsDesc": "Essayez une autre recherche."
  },
  "diseaseDetail": {
    "back": "Retour aux maladies",
    "bookmark": "Enregistrer",
    "bookmarked": "Enregistré",
    "share": "Partager",
    "linkCopied": "Lien copié dans le presse-papiers",
    "askAI": "Poser une question dessus",
    "reviewed": "Revue médicale vérifiée",
    "symptomsTitle": "Signes et symptômes fréquents",
    "symptomsSubtitle": "Manifestations cliniques habituelles.",
    "warningSignsTitle": "Signaux d'alarme critiques",
    "warningSignsSubtitle": "Symptômes nécessitant des soins urgents.",
    "riskFactorsTitle": "Facteurs de risque",
    "riskFactorsSubtitle": "Facteurs augmentant la vulnérabilité.",
    "preventionTitle": "Stratégies de prévention",
    "preventionSubtitle": "Mesures recommandées par l’OMS.",
    "whenToSeekCareTitle": "Quand consulter un médecin",
    "ctaTitle": "Des questions sur cette maladie ?",
    "ctaDesc": "Notre assistant IA peut répondre à vos questions d'information.",
    "startConversation": "Démarrer la discussion",
    "relatedTitle": "Affections associées"
  },
  "resources": {
    "badge": "Répertoire santé",
    "title": "Ressources de santé vérifiées",
    "subtitle": "Portails officiels et numéros d'urgence.",
    "emergencySectionTitle": "Services d'urgence",
    "emergencySectionDesc": "Appelez immédiatement en cas d’urgence médicale.",
    "callNow": "Appeler",
    "portalsTitle": "Portails officiels",
    "portalsSubtitle": "Sites de l'OMS et des autorités de santé.",
  ...
  "bookmarks": {
    ...
    "subtitle": "Vos guides et ressources sauvegardés.",
    "all": "Tout",
    "diseases": "Maladies",
    "external": "Ressources",
    "emptyTitle": "Aucun signet",
    "emptyDesc": "Enregistrez des guides pour les retrouver facilement.",
    "browseBtn": "Parcourir les maladies",
    "readGuide": "Lire le guide",
    "visitResource": "Consulter la ressource",
    "savedOn": "Enregistré le",
    "guestNotice": "Mode invité : signets stockés localement.",
    "signInLink": "Connectez-vous pour synchroniser"
  },
  "safety": {
    "mandatoryDisclaimer": "HealthWise AI est un outil éducatif et ne remplace pas un professionnel de santé agréé.",
    "emergencyEscalationTitle": "ALERTE D'URGENCE MÉDICALE",
    "emergencyEscalationMessage": "Ces symptômes peuvent nécessiter des soins immédiats. Contactez les urgences sans tarder."
  },
  "home": {
...
"faqBadge": "Common Questions",
  ...
  "voice": {
    "statusListening": "Écoute en cours... Parlez naturellement",
    "statusThinking": "Réflexion et vérification des faits médicaux...",
    "statusSpeaking": "Parle... (Appuyez ou parlez pour interrompre)",
    "statusInterrupted": "Interrompu ! À votre écoute...",
    "statusError": "Mode vocal indisponible",
    "statusIdle": "Voix HealthWise",
    "unavailableNotice": "L'entrée vocale n'est pas disponible pour cette langue.",
    "micPermissionDenied": "L'accès au microphone a été refusé.",
    "tapToSpeak": "Appuyez pour parler",
    "tapToInterrupt": "Appuyez pour interrompre",
    "speakingNotice": "L'écoute reprendra automatiquement à la fin de la réponse.",
    "closeVoice": "Fermer le mode vocal",
    "emergencyNotice": "Avis d'urgence médicale détecté.",
    "ttsUnavailableNotice": "La sortie vocale n'est pas disponible pour cette langue sur cet appareil."
  }
};
