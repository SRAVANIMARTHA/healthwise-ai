...
export const es: TranslationDictionary = {
  "nav": {
    ...
    "explainReport": "Explicar Informe",
    "signIn": "Iniciar Sesión",
    "signOut": "Cerrar Sesión",
    "selectLanguage": "Seleccionar Idioma",
    "appTitle": "HealthWise",
    "appSubtitle": "Concientización en Salud Pública"
  },
  "chat": {
    "title": "HealthWise AI",
    "evidenceGrounded": "Basado en Evidencia",
    "newChat": "Nueva Conversación",
    "startTitle": "Inicie una Conversación de Salud",
    "startDesc": "Pregunte sobre síntomas de enfermedades, consejos de prevención, calendarios de vacunación o nutrición.",
    "placeholder": "Pregunte sobre una enfermedad, síntoma, prevención, vacuna...",
    "send": "Enviar",
    "disclaimer": "Información educativa sobre salud. Consulte a un médico para consejo médico.",
    "analyzing": "Analizando literatura médica...",
    "emergencyAlertTitle": "ALERTA DE EMERGENCIA",
    "sources": "Fuentes:",
    "askAI": "Preguntar a la IA",
    "emergencyHotlines": "Líneas de Emergencia"
  },
  "diseases": {
    "badge": "Directorio Médico",
    "title": "Explorador de Enfermedades y Guías Clínicas",
    "subtitle": "Resúmenes basados en evidencia de la Organización Mundial de la Salud (OMS).",
    "searchPlaceholder": "Buscar enfermedades, síntomas o palabras clave...",
    "filterBy": "Filtrar:",
    "all": "Todos",
    "keySigns": "Signos Clínicos Clave:",
    "readGuide": "Leer Guía",
    "askAI": "Preguntar a la IA",
    "whoGrounded": "Basado en la OMS",
    "noResults": "No se encontraron enfermedades",
    "noResultsDesc": "Intente buscar con otros términos."
  },
  "diseaseDetail": {
    "back": "Volver a Enfermedades",
    "bookmark": "Guardar",
    "bookmarked": "Guardado",
    "share": "Compartir",
    "linkCopied": "Enlace copiado al portapapeles",
    "askAI": "Consultar a la IA sobre esto",
    "reviewed": "Revisión Médica Verificada",
    "symptomsTitle": "Signos y Síntomas Comunes",
    "symptomsSubtitle": "Manifestaciones clínicas habituales.",
    "warningSignsTitle": "Señales de Alarma Críticas",
    "warningSignsSubtitle": "Síntomas que requieren atención médica urgente.",
    "riskFactorsTitle": "Factores de Riesgo",
    "riskFactorsSubtitle": "Factores que aumentan la probabilidad de contagio o complicación.",
    "preventionTitle": "Estrategias de Prevención",
    "preventionSubtitle": "Medidas recomendadas por la OMS.",
    "whenToSeekCareTitle": "Cuándo Consultar al Médico",
    "ctaTitle": "¿Tiene preguntas sobre esta condición?",
    "ctaDesc": "Nuestro asistente educativo de IA puede responder sus dudas.",
    "startConversation": "Iniciar Conversación",
    "relatedTitle": "Condiciones de Salud Relacionadas"
  },
  "resources": {
    "badge": "Directorio de Salud",
    "title": "Recursos de Salud Verificados",
    "subtitle": "Portales oficiales y números de emergencia.",
    "emergencySectionTitle": "Servicios de Urgencia",
    "emergencySectionDesc": "Comuníquese inmediatamente en emergencias médicas.",
    "callNow": "Llamar",
    "portalsTitle": "Portales Oficiales de Salud",
    "portalsSubtitle": "Sitios web institucionales de la OMS y autoridades de salud.",
    "searchPlaceholder": "Buscar recursos o portales...",
    "visit": "Visitar",
    "verified": "Verificado"
  },
  "bookmarks": {
    "title": "Elementos Guardados",
    "subtitle": "Guías y recursos guardados en su cuenta.",
    "all": "Todos",
    "diseases": "Enfermedades",
    "external": "Recursos",
    "emptyTitle": "No hay marcadores guardados",
    "emptyDesc": "Guarde enfermedades y recursos para consultarlos fácilmente.",
    "browseBtn": "Explorar Enfermedades",
    "readGuide": "Leer Guía",
    "visitResource": "Visitar Recurso",
    "savedOn": "Guardado el",
    "guestNotice": "Modo invitado: los marcadores se almacenan localmente.",
    "signInLink": "Inicie sesión para sincronizar"
  },
  "safety": {
    "mandatoryDisclaimer": "HealthWise AI es una plataforma educativa de salud y no proporciona asesoramiento, diagnóstico ni tratamiento médico profesional.",
    "emergencyEscalationTitle": "ALERTA DE EMERGENCIA MÉDICA",
    "emergencyEscalationMessage": "Los síntomas descritos pueden indicar una condición potencialmente mortal. Llame inmediatamente al servicio de emergencias médicas."
  },
  "home": {
...
"faqBadge": "Common Questions",
  ...
  "voice": {
    "statusListening": "Escuchando... Hable con naturalidad",
    "statusThinking": "Pensando y verificando datos médicos...",
    "statusSpeaking": "Hablando... (Toque o hable para interrumpir)",
    "statusInterrupted": "¡Interrumpido! Escuchando de nuevo...",
    "statusError": "Modo de voz no disponible",
    "statusIdle": "Voz HealthWise",
    "unavailableNotice": "La entrada de voz no está disponible actualmente para este idioma.",
    "micPermissionDenied": "Acceso al micrófono denegado. Permita los permisos en su navegador.",
    "tapToSpeak": "Toque para hablar",
    "tapToInterrupt": "Toque para interrumpir",
    "speakingNotice": "Se volverá a escuchar automáticamente cuando termine la respuesta.",
    "closeVoice": "Cerrar modo de voz",
    "emergencyNotice": "Aviso de emergencia médica detectado.",
    "ttsUnavailableNotice": "La salida de voz no está disponible para este idioma en este dispositivo."
  }
};
