...
export const mr: TranslationDictionary = {
  "nav": {
    ...
    "explainReport": "अहवाल स्पष्ट करा",
    "signIn": "साइन इन",
    "signOut": "साइन आउट",
    "selectLanguage": "भाषा निवडा",
    "appTitle": "HealthWise",
    "appSubtitle": "सार्वजनिक आरोग्य जागरूकता"
  },
  "chat": {
    "title": "HealthWise AI",
    "evidenceGrounded": "पुराव्यांवर आधारित आरोग्य माहिती",
    "newChat": "नवीन संभाषण",
    "startTitle": "आरोग्य चर्चा सुरू करा",
    "startDesc": "लक्षणे, प्रतिबंधात्मक उपाय, लसीकरण वेळापत्रक किंवा आहाराविषयी विचारा.",
    "placeholder": "आजार, लक्षण, प्रतिबंध, लस याबद्दल विचारा...",
    "send": "पाठवा",
    "disclaimer": "केवळ शैक्षणिक माहिती. वैद्यकीय सल्ल्यासाठी डॉक्टरांचा सल्ला घ्या.",
    "analyzing": "वैद्यकीय माहितीचे विश्लेषण सुरू आहे...",
    "emergencyAlertTitle": "तातडीची चेतावणी",
    "sources": "संदर्भ व पुरावे:",
    "askAI": "AI ला विचारा",
    "emergencyHotlines": "आपत्कालीन हेल्पलाइन"
  },
  "diseases": {
    "badge": "वैद्यकीय माहिती",
    "title": "आजार माहिती व क्लिनिकल मार्गदर्शक",
    "subtitle": "जागतिक आरोग्य संघटनेच्या (WHO) अधिकृत अहवालांवर आधारित माहिती.",
    "searchPlaceholder": "आजार, लक्षणे किंवा कीवर्ड शोधा...",
    "filterBy": "फिल्टर:",
    "all": "सर्व",
    "keySigns": "मुख्य लक्षणे:",
    "readGuide": "मार्गदर्शक वाचा",
    "askAI": "AI ला विचारा",
    "whoGrounded": "WHO आधारित",
    "noResults": "कोणतेही आजार आढळले नाहीत",
    "noResultsDesc": "कृपया इतर शब्दांसह शोधण्याचा प्रयत्न करा."
  },
  "diseaseDetail": {
    "back": "आजारांच्या यादीकडे परत जा",
    "bookmark": "जतन करा",
    "bookmarked": "जतन केले",
    "share": "शेअर करा",
    "linkCopied": "लिंक कॉपी केली",
    "askAI": "याबद्दल AI ला विचारा",
    "reviewed": "वैद्यकीयदृष्ट्या तपासलेले",
    "symptomsTitle": "सामान्य लक्षणे",
    "symptomsSubtitle": "वारंवार आढळणारी लक्षणे.",
    "warningSignsTitle": "धोक्याचे इशारे",
    "warningSignsSubtitle": "ज्यासाठी तातडीने डॉक्टरांची गरज असते.",
    "riskFactorsTitle": "धोका वाढवणारे घटक",
    "riskFactorsSubtitle": "आजार होण्याची शक्यता वाढवणारे घटक.",
    "preventionTitle": "प्रतिबंधात्मक उपाय",
    "preventionSubtitle": "WHO ने शिफारस केलेले उपाय.",
    "whenToSeekCareTitle": "डॉक्टरांकडे कधी जावे",
    "ctaTitle": "काही शंका आहेत का?",
    "ctaDesc": "आमचा AI सहाय्यक आपल्याला मदत करण्यास तयार आहे.",
    "startConversation": "संभाषण सुरू करा",
    "relatedTitle": "संबंधित आरोग्य विषय"
  },
  "resources": {
    "badge": "आरोग्य संसाधने",
    "title": "सत्यापित आरोग्य माहिती",
    "subtitle": "अधिकृत पोर्टल्स आणि आपत्कालीन संपर्क क्रमांक.",
    "emergencySectionTitle": "आपत्कालीन सेवा",
    "emergencySectionDesc": "वैद्यकीय आणीबाणीच्या वेळी त्वरित संपर्क साधा.",
    "callNow": "कॉल करा",
    "portalsTitle": "अधिकृत पोर्टल्स",
    "portalsSubtitle": "WHO आणि आरोग्य विभागाच्या वेबसाइट्स.",
    "searchPlaceholder": "संसाधने शोधा...",
    "visit": "भेट द्या",
    "verified": "सत्यापित"
  },
  "bookmarks": {
    "title": "जतन केलेले विषय",
    "subtitle": "आपण बुकमार्क केलेले मार्गदर्शक.",
    "all": "सर्व",
    "diseases": "आजार",
    "external": "संसाधने",
    "emptyTitle": "कोणतेही बुकमार्क नाहीत",
    "emptyDesc": "महत्त्वाची माहिती नंतर पाहण्यासाठी जतन करा.",
    "browseBtn": "आजार पहा",
    "readGuide": "मार्गदर्शक वाचा",
    "visitResource": "संसाधन पहा",
    "savedOn": "जतन दिनांक:",
    "guestNotice": "अतिथी मोड: केवळ ब्राउझरमध्ये जतन केले जाईल.",
    "signInLink": "सिंक करण्यासाठी लॉगिन करा"
  },
  "safety": {
    "mandatoryDisclaimer": "HealthWise AI केवळ आरोग्य शिक्षणासाठी असून डॉक्टरांच्या उपचारांना पर्याय नाही.",
    "emergencyEscalationTitle": "आपत्कालीन इशारा",
    "emergencyEscalationMessage": "ही लक्षणे गंभीर असू शकतात. त्वरित रुग्णवाहिका (108) बोलवा."
  },
  "home": {
...
"faqBadge": "Common Questions",
  ...
  "voice": {
    "statusListening": "ऐकत आहे... सहज बोला",
    "statusThinking": "विचार करत आहे आणि वैद्यकीय तथ्ये तपासत आहे...",
    "statusSpeaking": "बोलत आहे... (थांबवण्यासाठी टॅप करा किंवा बोला)",
    "statusInterrupted": "व्यत्यय आला! पुन्हा ऐकत आहे...",
    "statusError": "व्हॉइस मोड उपलब्ध नाही",
    "statusIdle": "हेल्थवाइज व्हॉइस",
    "unavailableNotice": "या भाषेसाठी व्हॉइस इनपुट सध्या उपलब्ध नाही.",
    "micPermissionDenied": "मायक्रोफोन ऍक्सेस नाकारला गेला.",
    "tapToSpeak": "बोलण्यासाठी टॅप करा",
    "tapToInterrupt": "थांबवण्यासाठी टॅप करा",
    "speakingNotice": "उत्तर पूर्ण झाल्यावर आपोआप पुन्हा ऐकणे सुरू होईल.",
    "closeVoice": "व्हॉइस मोड बंद करा",
    "emergencyNotice": "तातडीची चेतावणी आढळली.",
    "ttsUnavailableNotice": "या डिव्हाइसवर या भाषेसाठी व्हॉइस आउटपुट उपलब्ध नाही."
  }
};
