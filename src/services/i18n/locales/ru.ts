...
export const ru: TranslationDictionary = {
  "nav": {
    ...
    "healthyHabits": "Здоровые Привычки",
    "resources": "Ресурсы",
    "bookmarks": "Закладки",
    "about": "О проекте",
    "dashboard": "Панель",
    ...
    "explainReport": "Разбор анализов",
    "signIn": "Войти",
    "signOut": "Выйти",
    "selectLanguage": "Выбрать язык",
    "appTitle": "HealthWise",
    "appSubtitle": "Информирование в сфере общественного здравоохранения"
  },
  "chat": {
    "title": "HealthWise AI",
    "evidenceGrounded": "На основе доказательной медицины",
    "newChat": "Новый диалог",
    "startTitle": "Начните беседу о здоровье",
    "startDesc": "Задайте вопрос о симптомах заболеваний, профилактике, вакцинации или питании.",
    "placeholder": "Спросите о болезни, симптоме, вакцине...",
    "send": "Отправить",
    "disclaimer": "Образовательная информация. Для постановки диагноза обратитесь к врачу.",
    "analyzing": "Анализ медицинских источников...",
    "emergencyAlertTitle": "ЭКСТРЕННОЕ ПРЕДУПРЕЖДЕНИЕ",
    "sources": "Источники:",
    "askAI": "Спросить ИИ",
    "emergencyHotlines": "Экстренные службы"
  },
  "diseases": {
    "badge": "Медицинский справочник",
    "title": "Справочник заболеваний и клинические руководства",
    "subtitle": "Доказательные данные Всемирной организации здравоохранения (ВОЗ).",
    "searchPlaceholder": "Поиск заболеваний, симптомов или терминов...",
    "filterBy": "Фильтр:",
    "all": "Все",
    "keySigns": "Ключевые симптомы:",
    "readGuide": "Читать руководство",
    "askAI": "Спросить ИИ",
    "whoGrounded": "Данные ВОЗ",
    "noResults": "Заболевания не найдены",
    "noResultsDesc": "Попробуйте изменить запрос."
  },
  "diseaseDetail": {
    "back": "Назад к заболеваниям",
    "bookmark": "Сохранить",
    "bookmarked": "Сохранено",
    "share": "Поделиться",
    "linkCopied": "Ссылка скопирована в буфер обмена",
    "askAI": "Задать вопрос об этом",
    "reviewed": "Медицинская проверка",
    "symptomsTitle": "Основные признаки и симптомы",
    "symptomsSubtitle": "Характерные клинические проявления.",
    "warningSignsTitle": "Критические сигналы тревоги",
    "warningSignsSubtitle": "Симптомы, требующие неотложной помощи.",
    "riskFactorsTitle": "Факторы риска",
    "riskFactorsSubtitle": "Факторы, повышающие вероятность болезни.",
    "preventionTitle": "Профилактика",
    "preventionSubtitle": "Рекомендации ВОЗ.",
    "whenToSeekCareTitle": "Когда обращаться к врачу",
    "ctaTitle": "Есть вопросы по этому заболеванию?",
    "ctaDesc": "Наш ассистент готов ответить на ваши вопросы.",
    "startConversation": "Начать беседу",
    "relatedTitle": "Связанные темы"
  },
  "resources": {
    "badge": "Каталог ресурсов",
    "title": "Проверенные ресурсы о здоровье",
    "subtitle": "Официальные порталы и телефоны экстренных служб.",
    "emergencySectionTitle": "Службы скорой помощи",
    "emergencySectionDesc": "При угрозе жизни звоните немедленно.",
    "callNow": "Позвонить",
    "portalsTitle": "Официальные порталы",
    "portalsSubtitle": "Сайты ВОЗ и органов здравоохранения.",
  ...
  "bookmarks": {
    ...
    "subtitle": "Ваши закладки руководств и ресурсов.",
    "all": "Все",
    "diseases": "Заболевания",
    "external": "Ресурсы",
    "emptyTitle": "Нет закладок",
    "emptyDesc": "Сохраняйте статьи для быстрого доступа.",
    "browseBtn": "Обзор заболеваний",
    "readGuide": "Читать руководство",
    "visitResource": "Открыть ресурс",
    "savedOn": "Сохранено",
    "guestNotice": "Гостевой режим: данные хранятся локально.",
    "signInLink": "Войдите для синхронизации"
  },
  "safety": {
    "mandatoryDisclaimer": "HealthWise AI предоставляет справочную информацию и не заменяет консультацию врача.",
    "emergencyEscalationTitle": "НЕОТЛОЖНАЯ СИТУАЦИЯ",
    "emergencyEscalationMessage": "Описанные симптомы могут быть опасны для жизни. Срочно вызовите скорую помощь."
  },
  "home": {
...
"faqBadge": "Common Questions",
  ...
  "voice": {
    "statusListening": "Слушаю... Говорите естественно",
    "statusThinking": "Думаю и проверяю медицинские данные...",
    "statusSpeaking": "Говорю... (Нажмите, чтобы прервать)",
    "statusInterrupted": "Прервано! Снова слушаю...",
    "statusError": "Голосовой режим недоступен",
    "statusIdle": "Голос HealthWise",
    "unavailableNotice": "Голосовой ввод в настоящее время недоступен для этого языка.",
    "micPermissionDenied": "В доступе к микрофону отказано.",
    "tapToSpeak": "Нажмите, чтобы говорить",
    "tapToInterrupt": "Нажмите, чтобы прервать",
    "speakingNotice": "Прослушивание продолжится автоматически после ответа.",
    "closeVoice": "Закрыть голосовой режим",
    "emergencyNotice": "Обнаружено экстренное предупреждение.",
    "ttsUnavailableNotice": "Голосовой вывод недоступен для этого языка на этом устройстве."
  }
};
